...
<div class="content">
			<form method="get" action="#">
				<div>
					<input type="date" id="textfield1" name="textfield1" value="" size="18" style="margin-left: 548px;margin-top: 38px;width: 261px;" />
...
<div style="padding:25px;">
		...
		try{
			...
			String searchDate=request.getParameter("textfield1");
			System.out.println(searchDate);
			Connection connection = null;
			String email = (String) session.getAttribute("email");
			String address=request.getParameter("address");
			String TableName="sticky"+email.split("@")[0];
			String sql = "select * from "+TableName+ " where start_date like '%"+searchDate+"%' OR end_date like '%"+searchDate+"%'";
...
<div class="absolute">
				<div class="pac-card" id="pac-card">
					...
					<input type="text" id="pac-input_<%=sid%>" onkeyup="initMap()" value="<%=location%>">
				</div>
				</div>
				<div id="map"></div>
			</div>
