...
<div class="content">
			<form method="post" action="SearchByLocation.jsp">
				<div>
		...
		try{
			...
			String searchLocation=request.getParameter("textfield1");
			System.out.println(searchLocation);
			Connection connection = null;
			String email = (String) session.getAttribute("email");
			String address=request.getParameter("address");
			String TableName="sticky"+email.split("@")[0];
			String sql = "select * from "+TableName+ " where address like '%"+searchLocation+"%'";
